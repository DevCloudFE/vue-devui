        ...
        <h1 class="title">
          <a target="_self" href="/home">
            <span class="logo">
              ...
              >
                <defs>
                  <linearGradient id="linearGradient-1" x1="89.5364583%" y1="21.60078%" x2="7.57349918%" y2="65.7395747%">
                    <stop stop-color="#2954C8" offset="0%" />
                    <stop stop-color="#5170FF" offset="100%" />
                  </linearGradient>
                  <linearGradient id="linearGradient-2" x1="89.5364583%" y1="21.4573588%" x2="7.57349918%" y2="65.8190624%">
                    <stop stop-color="#2954C8" offset="0%" />
                    <stop stop-color="#5170FF" offset="100%" />
                  </linearGradient>
                  <linearGradient id="linearGradient-3" x1="-11.5260417%" y1="24.3907324%" x2="87.1145833%" y2="74.8850926%">
                    <stop stop-color="#89D2FF" offset="0%" />
                    <stop stop-color="#5170FF" offset="100%" />
                  </linearGradient>
                  <linearGradient id="linearGradient-4" x1="0%" y1="18.4813953%" x2="75.9513522%" y2="81.5186047%">
                    <stop stop-color="#89D2FF" offset="0%" />
                    <stop stop-color="#5170FF" offset="100%" />
                  </linearGradient>
                </defs>
