  ...
  setup () {
    ...
    const cardActions=<>
      <div class="card-block">
        <DIcon name="icon-like" class="icon-like card-icon"></DIcon ><span>12</span>
      </div>
      <div class="card-block">
        <DIcon name="icon-star-o" class="icon-like card-icon"></DIcon ><span>8</span>
      </div>
      <div class="card-block">
        <DIcon name="icon-message" class="icon-like card-icon"></DIcon ><span>8</span>
      </div></>
    const slots = {
    ...
    return () => {
      return (
        <DCard class="d-card" align="start" src="https://devui.design/components/assets/image1.png" v-slots={slots}></DCard>);
    };
  }
});
