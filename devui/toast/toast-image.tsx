        ...
        case 'info':
          return (
            <g id='info' stroke='none' stroke-width='1' fill='none' fill-rule='evenodd'>
              <path
                class='devui-toast-image-info-path'
            ...
            <>
              ...
              <g id='correct' stroke='none' stroke-width='1' fill='none' fill-rule='evenodd'>
                <mask id='mask-2' fill='white'>
                  <use xlinkHref='#path-s'></use>
                </mask>
                <use id='Mask' class='devui-toast-image-success-path' xlinkHref='#path-s'></use>
              </g>
            </>
          )
        case 'warn':
          ...
          return (
            <>
              ...
              <g id='error' stroke='none' stroke-width='1' fill='none' fill-rule='evenodd'>
                <mask id='mask-2' fill='white'>
                  <use xlinkHref='#path-e'></use>
                </mask>
                <use id='Mask' class='devui-toast-image-error-path' xlinkHref='#path-e'></use>
              </g>
            </>
          )
      }
