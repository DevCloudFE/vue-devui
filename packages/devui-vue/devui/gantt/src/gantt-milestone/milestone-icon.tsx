      ...
      <g id="gantt-04fix" transform="translate(-189.000000, -423.000000)">
        <g id="gantt-Group-2" transform="translate(40.000000, 417.000000)">
          <g id="gant-group-4" transform="translate(148.000000, 6.000000)">
            ...
            <use
              id="gantt-men"
              fill="url(#gantt-linearGradient-1)"
              xlink:href="#gantt-path-2"
            />
            <polygon
            ...
            />
            <polygon
              fill="url(#gantt-linearGradient-11)"
              mask="url(#gantt-mask-3)"
              points="12 8 18 9 15 11 18 13 11 14"
            />
            <polygon
              fill="url(#gantt-linearGradient-12)"
              mask="url(#gantt-mask-3)"
              points="10 6 14 7 13 13 9 13"
            />
            <polygon
              fill="#FFE3A0"
              mask="url(#gantt-mask-3)"
              points="10 6 11 6 9 17 8 17"
            />
            <polygon
              fill="#B4832C"
              mask="url(#gantt-mask-3)"
              points="13 13 11 14 11.1707479 13"
            />
            <rect
              fill="#000000"
              opacity="0.100000001"
