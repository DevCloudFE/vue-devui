        ...
        <div class="devui-color-picker-panel">
          <d-tabs type="tabs" v-model={tab.value}>
            ...
            <d-tab id="palette" title={t('advancedPanel')} tabId="palette">
              <color-palette ref={paletteElement} v-model={paletteColorMap.value} onChangeTextColor={changeTextColor}></color-palette>
            </d-tab>
          </d-tabs>
          ...
          <colorEdit
            ...
            onChangeTextModeColor={changeTextModeColor}></colorEdit>
