import { nextTick, ref, Ref, SetupContext } from "vue";

export default function useKeyBoardHandle(dropDownRef: Ref<any>, visible: Ref<boolean>, searchList: Ref<Array<any>>, selectedIndex: Ref<number>, searchStatus: Ref<boolean>, showNoResultItemTemplate: Ref<boolean>, selectOptionClick: Function, handleClose: Function): any {
    ...
    const handlekeyDown = (e: KeyboardEvent) => {
        ...
        let status = visible.value && searchList.value.length && !searchStatus.value && !showNoResultItemTemplate.value
