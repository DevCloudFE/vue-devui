    ...
    <svg class={[ns.e('icon'), ns.em('icon', 'info')]} viewBox="0 0 16 16" version="1.1" xmlns="http://www.w3.org/2000/svg">
      <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <g stroke-width="1">
          ...
          C12.4,16 16,12.4 16,8 C16,3.6 12.4,0 8,0 Z M9,5 L7,5 L7,3 L9,3 L9,5 Z M9,12.6 L7,12.6 L7,6.6 L9,6.6 L9,12.6 Z"></path>
        </g>
      </g>
    </svg>
  );
    ...
    <svg
      ...
      <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path
          ...
          C16,3.6 12.4,0 8,0 Z M9,12.6 L7,12.6 L7,10.6 L9,10.6 L9,12.6 Z M9,9.1 L7,9.1 L6.9,3.1 L9.1,3.1 L9,9.1 Z"
