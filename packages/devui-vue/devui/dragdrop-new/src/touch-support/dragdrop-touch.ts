...
export class DragDropTouch {
  ...
  private static instance: DragDropTouch | null = null;
  ...
  // touched draggable element
  dragSource: HTMLElement | null;
  ptDown: { x: number; y: number } | null;
  ...
  constructor() {
    ...
    if (typeof document !== 'undefined') {
      ...
      if (DragDropTouch.isTouchDevice()) {
        ...
        this.touchmoveListener = this.touchmove as EventListener;
        this.touchendListener = this.touchend as EventListener;
  ...
  bindTouchmoveTouchend(e: TouchEvent) {
    ...
    (e.target as Node).addEventListener('touchmove', this.touchmoveListener, this.listenerOpt);
    (e.target as Node).addEventListener('touchend', this.touchendListener);
    (e.target as Node).addEventListener('touchcancel', this.touchendListener);
  }
