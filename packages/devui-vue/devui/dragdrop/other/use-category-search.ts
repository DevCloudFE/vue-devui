...
import { categorySearchInjectionKey, ExtendedConfig } from '../category-search-types';
import type { CategorySearchProps, ICategorySearchTagItem, SearchConfig, ITagOption, TextConfig } from '../category-search-types';
...
export function useCategorySearch(props: CategorySearchProps, ctx: SetupContext) {
  ...
  const operationConfig: ExtendedConfig = reactive({
    clear: { show: true },
    save: { show: true },
    more: { show: false },
  });
