              ...
              <svg width="16px" height="16px" viewBox="0 0 16 16" version="1.1">
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                  <polygon
                    fill="#293040"
                    fill-rule="nonzero"
                    points="8 6.58578644 12.2426407 2.34314575 13.6568542 3.75735931 9.41421356 8\
                     13.6568542 12.2426407 12.2426407 13.6568542 8 9.41421356 3.75735931 13.6568542\
                      2.34314575 12.2426407 6.58578644 8 2.34314575 3.75735931 3.75735931 2.34314575"></polygon>
                </g>
              </svg>
            </button>
              ...
              <svg width="18px" height="18px" viewBox="0 0 16 16" version="1.1">
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                  <polygon
                    fill="#293040"
                    fill-rule="nonzero"
                    points="10.7071068 12.2928932 9.29289322 13.7071068 3.58578644 8 9.29289322\
                     2.29289322 10.7071068 3.70710678 6.41421356 8"></polygon>
                </g>
              </svg>
            </button>
              ...
              <svg width="18px" height="18px" viewBox="0 0 16 16" version="1.1">
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                  <polygon
                    ...
                    points="11.7071068 12.2928932 10.2928932 13.7071068 4.58578644 8 10.2928932 2.29289322\
                     11.7071068 3.70710678 7.41421356 8"></polygon>
                </g>
              </svg>
            </button>
            {/* 底部固定区 */}
                ...
                <svg width="16px" height="16px" viewBox="0 0 16 16" version="1.1">
                  <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    <polygon
                      fill="#293040"
                      fill-rule="nonzero"
                      points="10.7071068 12.2928932 9.29289322 13.7071068 3.58578644 8 9.29289322 2.29289322\
                       10.7071068 3.70710678 6.41421356 8"></polygon>
                  </g>
                </svg>
              </button>
