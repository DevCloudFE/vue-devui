...
| prefix                   | `string`                                | --                                        | 可选，自定义前缀图标                                              | [带图标的输入框](./input#带图标的输入框)        |
| suffix                   | `string`                                | --                                        | 可选，自定义后缀图标                                              | [带图标的输入框](./input#带图标的输入框)        |
| clearable                | `boolean`                               | false                                     | 可选，是否可清空                                                  | [参考 `d-input` 一键清空](./input#一键清空) |
...
| prefix    | 可选，输入框头部内容                                                     | [带图标的输入框](./input#带图标的输入框) |
| suffix    | 可选，输入框尾部内容                                                     | [带图标的输入框](./input#带图标的输入框) |
| prepend   | 可选，输入框前置内容                                                     | [复合型输入框](./input#复合型输入框)     |
| append    | 可选，输入框后置内容                                                     | [复合型输入框](./input#复合型输入框)     |
